...
function HeroParallex({ products }) {
  ...
  return (
    <div
      ref={ref}
      className="w-screen h-[200vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
