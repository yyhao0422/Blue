...
export default function FlashCard() {
  ...
  return isSignedIn ? (
    <div className="p-16 !w-full">
      <div className="font-bold text-5xl text-white">Flash Card</div>
      <div className="grid grid-cols-4 grid-rows-2 gap-x-3 gap-y-5 mt-5">
              ...
              >
                <div className="flip-card-front">
                  <div className={frontBodyStyle}>
                    <div className="text-xs text-white text-right w-full px-5">
                      Card {idx + 1}
                    </div>
                    <div
                      className="flip-card-profile h-[250px] w-[250px] bg-white rounded-full overflow-hidden"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex my-5 gap-3 justify-end">
                          {_.take(category.question, 3).map((question, idx) => (
                            <div
                              className="h-[50px] w-[50px] bg-white rounded-md overflow-hidden"
                              key={`quest-${idx}`}
                            >
                              <img
                                className="h-full w-full object-cover"
                    ...
                    <div className={innerStyle}>
                      <div className="text-white text-xs underline underline-offset-4">
                        A great card.
                      </div>
                ...
                <div className="flip-card-back">
                  <div className={backBodyStyle}>
                    <span className="text-xs text-center text-white p-5">
