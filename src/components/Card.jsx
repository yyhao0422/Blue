...
export default function FlashCardComponent({ title, link, image, alt, state }) {
  return (
    <Link
      to={link}
      state={state}
      className="bg-gradient-to-r from-[#FFD6FF] to-[#E7C6FF] card-item overflow-hidden p-5 pb-0 transition-all duration-500  hover:shadow-2xl hover:scale-105 group h-auto"
    >
      <img
